 ...
 * ---------------------------------------------------------------------------*/
    ...
    #pragma message "error: === p33SMPS_pps: selected device type not supported ==="

#endif

// PROTOTYPES FOR p33SMPS_pps.c
    
extern volatile uint16_t smpsPPS_RemapOutput(volatile uint8_t pinno, volatile uint8_t peripheral);
extern volatile uint16_t smpsPPS_UnmapOutput(volatile uint8_t pinno);
extern volatile uint16_t smpsPPS_RemapInput(volatile uint8_t pinno, volatile uint8_t* peripheral);
extern volatile uint16_t smpsPPS_UnmapInput(volatile uint8_t* peripheral);
extern volatile uint16_t smpsPPS_LockIO(void);
extern volatile uint16_t smpsPPS_UnlockIO(void);

#endif // end of MCAL_P33SMPS_PPS_H
// End of File 
